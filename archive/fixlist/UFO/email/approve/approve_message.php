<p>Dear <?php echo ucfirst(strtolower($studentName)); ?>,</p>

<p>Congrats! Your advisor has approved your transition to campus. You are now set up to register for on campus courses, and you should be able to register for those on-campus courses on your registration start date and time; you can find out your registration start date and time on your one.uf account. It is your responsibility to clear any other registration holds, so please check those frequently and resolve them in a timely manner. I am copying the UF Online OneStop on this email so they can add this transition contract to your file. Below, you&#39;ll see the summary of the transition contract you previously submitted, which you can keep for your records. If you have any issues with registration, please let me know.</p>
