...
<form action="campus.php" method="post">
  ...
  <div class="inputShell">
    ...
    <p>I give permission for my advisor to transition me to campus enrollment in the PaCE major listed above for the following term:</p>
    <select required name="semester">
      <option disabled selected value>select a semester</option>
      <option value="spring19">2019 | Spring</option>
      <option value="summer19">2019 | Summer A/C</option>
      <option value="fall19">2019 | Fall</option>
    </select>
  ...
  <div id="stipulations" class="inputShell">
    ...
    <input class="checkBox" type="checkbox" name="rescind_transition" value="rescind_transition">
  ...
  <div class="inputShell">
    ...
    <input class="checkBox" type="checkbox" name="ufo_future" value="ufo_future">
    ...
    <input class="checkBox" type="checkbox" name="ufo_dropCourses" value="ufo_dropCourses">
    <div class="divider"></div>
    ...
    <input class="checkBox" type="checkbox" name="ufo_finances" value="ufo_finances">
  </div><!-- input shell -->
  <div class="inputShell">
    ...
    <input class="checkBox" type="checkbox" name="major_nonPace" value="major_nonPace">
  </div><!-- input shell -->
  <div class="inputShell">
    ...
    <input class="checkBox" type="checkbox" name="transitionTerms" value="transitionTerms">
  </div><!-- input shell -->
  <div class="inputShell">
    <h3 class="orange">Failure Notice</h3>
    <p>If do not pass my current classes (including failing a class or withdrawing from a class), or fail to meet the transition requirements in any way, I will inform my advisor: <a href="#">Nicole Raymond</a>. This may impact my transition eligibility, so I will discuss the implications with my advisor.</p>
    <input class="checkBox" type="checkbox" name="failure_notice" value="failure_notice">
  </div><!-- input shell -->
  <div class="inputShell">
