...
<p><b>Thank you for submitting the UF Online PaCE Transition to campus form. Your advisor will now work on processing your transition form. Once you have received a confirmation email from your advisor that your form has been processed, you will be set up to register for on-campus classes for future semesters. In the meantime, it is your responsibility to clear any other holds that you have that may impact your future registration.</b></p>

<p>This message is a receipt for the transition contract. By submitting this form, you have acknowledged that you understand the following:</p>
