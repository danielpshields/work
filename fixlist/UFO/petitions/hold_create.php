        ...
        <table id="petitionTable">
          ...
          <tbody>
            ...
            <?php if (!$option == "drop") { ?>
              ...
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionA=drop">Drop Courses</a></td>
              </tr>
            <?php } ?>
            <?php if (!$option == "probation") { ?>
            <tr>
              <td><img src="image/icons/probation.png"></td>
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionB=probation">Academic Probation</a></td>
            </tr>
            <?php } ?>
            <?php if (!$optionC == "track") { ?>
            <tr>
              <td><img src="image/icons/track.png"></td>
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionC=track">Off-Track Continuation</a></td>
            </tr>
            <?php } ?>
            <?php if (!$optionD == "break") { ?>
            <tr>
              <td><img class="image_addOption_larger" src="image/icons/break.png"></td>
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionD=break">Petition to Break Residency</a></td>
            </tr>
            <?php } ?>
            <?php if (!$optionE == "dual") { ?>
            <tr>
              <td><img class="image_addOption_larger" src="image/icons/dual.png"></td>
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionE=dual">Dual Enrollment</a></td>
            </tr>
            <?php } ?>
            <?php if (!$optionF == "other") { ?>
            <tr>
              <td><img src="image/icons/other.png"></td>
              <td><a href="<?php echo $path; ?>create.php?getSet=true<?php echo $savedInfo; ?>&optionF=other">Other</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
