...
?>
  <div id="content">
    ...
    <!-- <ul>
      <li><a href="courses-change.php">change</a></li>
      <li><a href="courses-restart.php">restart</a></li>
    </ul> -->
    ...
    <table class="table">
      ...
      <p>Courses offered by the UF College of Medicine:</p>
      <table class="table">
        <tr>
          <td>MDU4003</td>
      ...
      <tr>
        <td>GMS5605</td>
        <td>Medical Anatomy</td>
      </tr>
      <tr>
        <td>GMS5605L</td>
        <td>Medical Anatomy Lab</td>
      </tr>
      <tr>
        <td>GMS5630</td>
      ...
      <tr>
        <td>GMS6400C</td>
        <td>Principals of Physiology</td>
      </tr>
    </table>
