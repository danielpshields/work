...
?>
  <div id="content">
    ...
    <!-- <h2>Programs:</h2>
    <ul>
      <li><a href="admission-change.php" target="_blank">Career Changers</a></li>
      <li><a href="admission-restart.php" target="_blank">Restart</a></li>
    </ul> -->


<!-- start spitting combination page -->
...
<li>Have a minimum of 3.0 in any pre-professional science courses already completed.</li>
  ...
  <div id="apply">
    <h2><a href="apply.php">Application</a></h2>
  </div>
